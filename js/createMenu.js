...
function createMenu() {
    ...
    Ul.classList.add("p-megaMenu__lv01Wrap");
    for (let i = 1; i <= 4; i++) {
        const Li = document.createElement("li");
        const Anker = document.createElement("a");
        Li.classList.add("p-megaMenu__lv01Item");
        const title = "0" + i;
...
function createMenuChild02(title) {
    ...
    const Ul = document.createElement("ul");
    DivPosition.classList.add("p-megaMenu__lv02Position");
    DivWidth.classList.add("p-megaMenu__lv02Width");
    Ul.classList.add("p-megaMenu__lv02Wrap");
    for (let i = 1; i <= 4; i++) {
        const Li = document.createElement("li");
        const Anker = document.createElement("a");
        Li.classList.add("p-megaMenu__lv02Item");
...
function createMenuChild03(title02) {
    const Ul = document.createElement("ul");
    Ul.classList.add("p-megaMenu__lv03Wrap");
    for (let i = 1; i <= 4; i++) {
        const Li = document.createElement("li");
        const Anker = document.createElement("a");
        Li.classList.add("p-megaMenu__lv03Item");
...
function createMenuChild04(title03) {
    const Ul = document.createElement("ul");
    Ul.classList.add("p-megaMenu__lv04Wrap");
    for (let i = 1; i <= 4; i++) {
        const Li = document.createElement("li");
        const Anker = document.createElement("a");
        Li.classList.add("p-megaMenu__lv04Item");
